        ...
        <section className="relative py-12 overflow-hidden md:py-16 lg:py-20">
            ...
            <div className="container relative z-10 px-4 mx-auto sm:px-6 lg:px-8">
                ...
                >
                    ...
                    >
                        <Trophy className="text-orange-500" size={isMobile ? 24 : 32} />
                    ...
                    >
                        The moment we've all been waiting for - witness the ultimate showdown!
                    </motion.p>
                </motion.div>
                    ...
                    >
                        ...
                        <div className="relative overflow-hidden border bg-black/40 backdrop-blur-sm rounded-xl md:rounded-2xl border-orange-500/30">
                            ...
                            >
                                ...
                                {/* Poster Image */}
                                <motion.img
                                    src="/finale-poster.jpeg"
                                    alt="Innovit 2026 Grand Finale"
